...
Congratulations, :smiley: :clap: :star2: we did it. The complete test script can
be found at
...
<h1 className="no_toc">
  <center>
    <a
      href="https://github.com/naveennamani/pywin-contextmenu"
      target="_blank"
      rel="noopener noreferrer"
...
checkout the pypi package [here](https://pypi.org/project/pywin-contextmenu/)
and the source code [here](https://github.com/naveennamani/pywin_contextmenu).

---

<h4 className="no_toc" style={{ color: "red" }}>
  There is happiness in doing random things at random times with random people.
</h4>
<h1 className="no_toc">&copy; Naveen Namani</h1>
